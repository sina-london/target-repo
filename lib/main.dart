...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return  ValueListenableBuilder<Box>(
      ...
      builder: (context, box, child) =>  MaterialApp.router(
        debugShowCheckedModeBanner: false,
        theme: FlexThemeData.light(
          scheme: _settingsBox?.getSettings()?.appearanceSettings?.colorScheme,
        ...
        darkTheme: FlexThemeData.dark(
          scheme: _isBoxInitialized
              ? _settingsBox?.getSettings()?.appearanceSettings?.colorScheme
              : null,
          appBarStyle: FlexAppBarStyle.material,
          appBarElevation: 4.0,
          darkIsTrueBlack: _isBoxInitialized
              ? _settingsBox?.getSettings()?.appearanceSettings?.amoled ?? false
              : false,
          blendLevel: 15,
          bottomAppBarElevation: 8.0,
          tabBarStyle: FlexTabBarStyle.forAppBar,
        ...
        themeMode: _isBoxInitialized
            ? _settingsBox!.getSettings()!.appearanceSettings!.themeMode ==
                    'light'
                ? ThemeMode.light
                : _settingsBox!.getSettings()!.appearanceSettings!.themeMode ==
                        'light'
