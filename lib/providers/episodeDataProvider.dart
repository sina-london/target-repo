...
import 'package:shonenx/providers/playerStateProvider.dart';
...
class EpisodeDataNotifier extends AutoDisposeNotifier<EpisodeDataState> {
  AnimeProvider get _animeProvider => ref.read(currentAnimeProviderProvider)!;
  ...
  Future<void> _fetchStreamData({Duration startAt = Duration.zero}) async {
    if (state.selectedEpisodeIdx == null || state.selectedServer == null) {
      return;
    }
