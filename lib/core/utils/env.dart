...
class Env {
  static const COMMENTUM_API_URL =
      String.fromEnvironment('COMMENTUM_API_URL');

  static const ANILIST_CLIENT_ID =
      String.fromEnvironment('ANILIST_CLIENT_ID');

  static const ANILIST_CLIENT_SECRET =
      String.fromEnvironment('ANILIST_CLIENT_SECRET');

  static const MAL_CLIENT_ID =
      String.fromEnvironment('MAL_CLIENT_ID');

  static const MAL_CLIENT_SECRET =
      String.fromEnvironment('MAL_CLIENT_SECRET');
  ...
  static List<String> get MAL_CLIENT_ID_LIST =>
      MAL_CLIENT_ID.split('|');
